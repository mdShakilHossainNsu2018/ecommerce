...
class GuestForm(forms.ModelForm):
    email = forms.EmailField(label='', widget=forms.EmailInput(attrs={'class': 'fadeIn second login_input',
...
class LoginForm(forms.Form):
    email = forms.EmailField(label='', widget=forms.EmailInput(attrs={'class': 'fadeIn second login_input',
                                                                      "placeholder": "Enter your email"}))
    password = forms.CharField(label='', widget=forms.PasswordInput(attrs={"class": "fadeIn third login_input",
...
class RegisterForm(forms.ModelForm):
    ...
    email = forms.EmailField(label='',
                             widget=forms.EmailInput(attrs={'class': 'fadeIn first login_input',
                                                            "placeholder": "Enter Your Email."}))
    password1 = forms.CharField(label='',
                                widget=forms.PasswordInput(attrs={'class': 'fadeIn second login_input',
